...
path_lowquota   <- read_excel("data/LowQuota_adopt_impl.xlsx")
path_highquota  <- read_excel("data/HighQuota_adopt_implement.xlsx")
path_femrep     <- read_excel("data/women_representation.xlsx")
path_granararaw <- read_excel("data/Base de datos_WomensRepresentation.xls")
                              
#ministry of labor aggregate data for low quota (1990–2003) 
path_unem_9003  <- read_excel("data/LaborMarket_Data/UnemploymentRate_UrbanAgglomeration_Women_1990-2003.xls", skip = 2)
path_emp_9003   <- read_excel("data/LaborMarket_Data/EmploymentRate_UrbanAgglomeration_Women_1990-2003.xls",   skip = 2)
path_LFP_9003   <- read_excel("data/LaborMarket_Data/female_LFPR_1990-2003.xls",   skip = 2)
path_underemp_9003 <- read_excel("data/LaborMarket_Data/female_underemploymentrate_1990-2003.xls",   skip = 2)
path_overemp_9003 <- read_excel("data/LaborMarket_Data/female_overemp_1990-2003.xls",   skip = 2)
...
path_EH_1996 <- read.dbf("data/LaborMarket_Data/EH_ind_1996_2.DBF", as.is = TRUE)
path_EH_1997 <- read.dbf("data/LaborMarket_Data/EH_ind_1997.DBF",     as.is = TRUE)
path_EH_1998 <- read.dbf("data/LaborMarket_Data/EH_ind_1998_2.DBF",   as.is = TRUE)
path_EH_1999 <- read.dbf("data/LaborMarket_Data/EH_ind_1999.DBF",     as.is = TRUE)
path_EH_2000 <- read.dbf("data/LaborMarket_Data/EH_ind_2000.DBF",     as.is = TRUE)
path_EH_2001 <- read.dbf("data/LaborMarket_Data/EH_ind_2001.DBF",     as.is = TRUE)
path_EH_2002 <- read.dbf("data/LaborMarket_Data/EH_ind_2002.DBF",     as.is = TRUE)
path_EH_2003 <- read_dta("data/LaborMarket_Data/EH_ind_2003.dta")
path_EH_2004 <- read_dta("data/LaborMarket_Data/EH_ind_2004_2.dta")
path_EH_2005 <- read_dta("data/LaborMarket_Data/EH_ind_2005_2.dta")
path_EH_2006 <- read_dta("data/LaborMarket_Data/EH_ind_2006_2.dta")
path_EH_2007 <- read_dta("data/LaborMarket_Data/EH_ind_2007_2.dta")
path_EH_2008 <- read_dta("data/LaborMarket_Data/EH_ind_2008_2.dta")
path_EH_2009 <- read_dta("data/LaborMarket_Data/EH_ind_2009_2.dta")
path_EH_2010 <- read_dta("data/LaborMarket_Data/EH_ind_2010_2.dta")
path_EH_2011 <- read_dta("data/LaborMarket_Data/EH_ind_2011_2.dta")
path_EH_2012 <- read_dta("data/LaborMarket_Data/EH_ind_2012_2.dta")
path_EH_2013 <- read_dta("data/LaborMarket_Data/EH_ind_2013_2.dta")
path_EH_2014 <- read_dta("data/LaborMarket_Data/EH_ind_2014_2.dta")
path_EH_2015 <- read_dta("data/LaborMarket_Data/EH_ind_2015_2.dta")
path_EH_2016 <- read_excel("data/LaborMarket_Data/EH_ind_2016_2.xls")
path_EH_2017 <- read_excel("data/LaborMarket_Data/EH_ind_2017_2.xls")
path_EH_2018 <- read_excel("data/LaborMarket_Data/EH_ind_2018_2.xls")
path_EH_2019 <- read_excel("data/LaborMarket_Data/EH_ind_2019_2.xls")
path_EH_2020_1 <- read_excel("data/LaborMarket_Data/EH_ind_2020_1.xlsx")
path_EH_2020 <- read_excel("data/LaborMarket_Data/EH_ind_2020_2.xlsx")
path_EH_2020_3 <- read_excel("data/LaborMarket_Data/EH_ind_2020_3.xlsx")
path_EH_2020_4 <- read_excel("data/LaborMarket_Data/EH_ind_2020_4.xlsx")
path_EH_2021 <- read_excel("data/LaborMarket_Data/EH_ind_2021_2.xlsx")
path_EH_2022 <- read_excel("data/LaborMarket_Data/EH_ind_2022_2.xlsx")
path_EH_2023 <- read_excel("data/LaborMarket_Data/EH_ind_2023_2.xlsx")
path_EH_2023_1 <- read_excel("data/LaborMarket_Data/EH_ind_2023_1.xlsx")
path_EH_2024 <- read_excel("data/LaborMarket_Data/EH_ind_2024_2.xlsx")
path_EH_2024_3 <- read_excel("data/LaborMarket_Data/EH_ind_2024_3.xlsx")
path_EH_2024_1 <- read_excel("data/LaborMarket_Data/EH_ind_2024_1.xlsx")
path_EH_2024_4 <- read_excel("data/LaborMarket_Data/EH_ind_2024_4.xlsx")
path_EH_2025 <- read_excel("data/LaborMarket_Data/EH_ind_2025_2.xlsx")
